...
fun NewPasswordScreen(navController: NavHostController) {
    ...
    var newPasswordConfirmationValue by remember { mutableStateOf("") }
    ...
    Surface(
        ...
        Column(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = {
                        Text(text = "Повторите новый пароль")
                    },
                    modifier = Modifier.fillMaxWidth(),
                    onValueChange = { newPasswordConfirmationValue = it }
                )
            }
        }
        ...
        Row(
            ...
            Row(
                ...
                Button(
                    onClick = { navController.navigate(AuthScreens.PASSWORD.name) }
                ) {
                    Text(text = "Далее")
                }
            }
